...
import 'package:audioplayers/audioplayers.dart'; // Add if not already
import '../services/updateprogress.dart'; // Ensure this is imported
...
class _MazeGameState extends State<MazeGame> {
  ...
  final AudioPlayer _audioPlayer = AudioPlayer(); // at class level
    ...
    Widget _buildQuestionBox() {
      ...
      return Container(
        width:
          ...
          MediaQuery.of(context).size.width * 0.85, // ✅ Slightly reduced width
